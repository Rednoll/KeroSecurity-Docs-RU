...
Декларирование схем с помощью :doc:`KSDL</usage/ksdl>` в большинстве случаев полезно для больших проектов, либо для проектов, которым необходимо динамически* менять схемы доступа. Kero-Security предлагает множество вариантов получения KSDL схем, некоторые из них:
